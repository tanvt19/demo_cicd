...
class GalleryLocalizationsKk extends GalleryLocalizations {
  ...
  @override
  String get deselect => 'Таңдаудан алу';
  ...
  @override
  String get selectable => 'Таңдалмалы (ұзақ басу)';

  @override
  String get selected => 'Таңдалған';
  ...
  @override
  String get rallySettingsPaperlessSettings => 'Виртуалдық реттеулер';
  ...
  @override
  String get demoMenuPreview => 'Алдын ала көру';
  ...
  @override
  String get demoCupertinoPickerSubtitle => 'iOS стиліндегі таңдағыштар';
  ...
  @override
  String get demoCupertinoPicker => 'Таңдағыш';
  ...
  @override
  String get demoCupertinoSearchTextFieldTitle => 'Мәтін іздеу өрісі';
  ...
  @override
  String get demoCupertinoSearchTextFieldPlaceholder => 'Бірдеңе жазыңыз.';

  @override
  String get demoCupertinoScrollbarTitle => 'Айналдыру жолағы';
  ...
  @override
  String get demoSharedZAxisPrivacySettingLabel => 'Құпиялық';
  ...
  @override
  String get bottomAppBar => 'Төменгі қолданба жолағы';

  @override
  String get loading => 'Жүктеліп жатыр.';
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      totalProperties,
      locale: localeName,
      other: '$totalProperties қолжетімді қонақ үй',
      one: '1 қолжетімді қонақ үй',
      zero: 'Қолжетімді қонақ үйлер жоқ',
    );
    return '$_temp0';
  }
