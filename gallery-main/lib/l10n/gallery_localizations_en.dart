...
class GalleryLocalizationsEnCa extends GalleryLocalizationsEn {
  ...
  @override
  String get demoSelectionControlsCheckboxDescription =>
      'Check boxes allow the user to select multiple options from a set. A normal check box\'s value is true or false, and a tristate check box\'s value can also be null.';
