...
class GalleryLocalizationsGl extends GalleryLocalizations {
  ...
  String rallyAlertsMessageUnassignedTransactions(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Aumenta a túa posible dedución de impostos. Escolle categorías para $count transaccións sen asignar.',
      one:
          'Aumenta a túa posible dedución de impostos. Escolle categorías para 1 transacción sen asignar.',
    );
    return '$_temp0';
  }
