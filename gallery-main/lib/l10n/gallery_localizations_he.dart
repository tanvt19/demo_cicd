...
class GalleryLocalizationsHe extends GalleryLocalizations {
  ...
  @override
  String get deselect => 'ביטול הבחירה';
  ...
  @override
  String get selectable => 'ניתן לבחירה (בלחיצה ארוכה)';
  ...
  @override
  String get demoCupertinoPickerSubtitle => 'בוררים בסגנון iOS';
  ...
  @override
  String get demoCupertinoPicker => 'בורר';
  ...
  @override
  String get demoCupertinoSearchTextFieldTitle => 'שדה טקסט לחיפוש';

  @override
  String get demoCupertinoSearchTextFieldSubtitle =>
      'שדה טקסט לחיפוש בסגנון iOS';
  ...
  @override
  String get demoCupertinoSearchTextFieldPlaceholder => 'יש להזין טקסט';

  @override
  String get demoCupertinoScrollbarTitle => 'סרגל גלילה';

  @override
  String get demoCupertinoScrollbarSubtitle => 'סרגל גלילה בסגנון iOS';
  ...
  @override
  String get demo => 'הדגמה';

  @override
  String get bottomAppBar => 'סרגל האפליקציה התחתון';
  ...
  String shrineScreenReaderCart(num quantity) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      two: 'עגלת קניות, $quantity פריטים',
  ...
  String craneSleepProperties(num totalProperties) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      two: '$totalProperties נכסים זמינים',
      one: 'נכס אחד זמין',
