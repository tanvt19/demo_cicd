...
class GalleryLocalizationsBe extends GalleryLocalizations {
  ...
  @override
  String get deselect => 'Скасаваць выбар';
  ...
  @override
  String get selectable => 'Магчымасць выбару (доўгім націсканнем)';
  ...
  String get replyDescription =>
      'Эфектыўная спецыялізаваная праграма электроннай пошты';
  ...
  String get demoAppBarSubtitle =>
      'Паказвае інфармацыю і дзеянні, звязаныя з бягучым экранам';

  @override
  String get demoAppBarDescription =>
      'Панэль праграм прапануе змесціва і дзеянні, звязаныя з бягучым экранам. Яна выкарыстоўваецца для брэндынгу, назваў экранаў, навігацыі і дзеянняў';
  ...
  String get demoButtonSubtitle =>
      'Тэкставыя, прыпаднятыя, з контурамі і іншыя';
  ...
  String get demoTextButtonDescription =>
      'Пры націсканні тэкставай кнопкі паказваецца эфект чарніла, і кнопка не падымаецца ўверх. Выкарыстоўвайце тэкставыя кнопкі на панэлі інструментаў, у дыялогавых вокнах і ў тэксце з палямі';
  ...
  String get demoElevatedButtonDescription =>
      'Прыпаднятыя кнопкі надаюць аб\'ёмнасць пераважна плоскім макетам. Яны паказваюць функцыі ў занятых або шырокіх абласцях.';
  ...
  String get demoDividerSubtitle =>
      'Раздзяляльнік – гэта тонкая лінія, якая раздзяляе групы змесціва ў спісах і макетах.';

  @override
  String get demoDividerDescription =>
      'Раздзяляльнікі можна выкарыстоўваць у спісах, высоўных меню і іншых месцах для раздзялення змесціва.';
  ...
  String get demoNavigationDrawerSubtitle =>
      'Паказ высоўнага меню на панэлі праграм';

  @override
  String get demoNavigationDrawerDescription =>
      'Панэль \"Матэрыяльны дызайн\" высоўваецца па гарызанталі з краю экрана і змяшчае спасылкі для навігацыі па праграме.';
  ...
  String get demoNavigationDrawerText =>
      'Каб пабачыць высоўнае меню, правядзіце пальцам ад краю ці дакраніцеся да верхняга левага значка';
  ...
  String get demoNavigationRailDescription =>
      'Матэрыяльны віджэт, які паказваецца з левага ці правага боку на экране праграмы і прызначаны для навігацыі паміж невялікай колькасцю старонак (звычайна 3-5).';
  ...
  String get demoCupertinoContextMenuDescription =>
      'Поўнаэкраннае кантэкстнае меню ў стылі iOS, якое паказваецца пры доўгім націсканні на элемент.';
  ...
  String get demoCupertinoContextMenuActionText =>
      'Каб адкрыць кантэкстнае меню, націсніце і ўтрымлівайце лагатып Flutter.';
  ...
  @override
  String get demoCupertinoPickerSubtitle => 'Інструменты выбару ў стылі iOS';

  @override
  String get demoCupertinoPickerDescription =>
      'Віджэт інструмента выбару ў стылі iOS, які можа выкарыстоўвацца для выбару радкоў, дат, часу ці адначасова даты і часу.';

  @override
  String get demoCupertinoPickerTimer => 'Таймер';

  @override
  String get demoCupertinoPicker => 'Інструмент выбару';
  ...
  @override
  String get demoCupertinoSearchTextFieldTitle => 'Поле крытэрыю пошуку';

  @override
  String get demoCupertinoSearchTextFieldSubtitle =>
      'Поле крытэрыю пошуку ў стылі iOS';

  @override
  String get demoCupertinoSearchTextFieldDescription =>
      'Поле крытэрыю пошуку, якое дазваляе карыстальніку ўводзіць пошукавы тэрмін і прапануе і адфільтроўвае прапановы.';

  @override
  String get demoCupertinoSearchTextFieldPlaceholder =>
      'Увядзіце пошукавы тэрмін';

  @override
  String get demoCupertinoScrollbarTitle => 'Паласа прагортвання';

  @override
  String get demoCupertinoScrollbarSubtitle =>
      'Паласа прагортвання ў стылі iOS';

  @override
  String get demoCupertinoScrollbarDescription =>
      'Паласа прагортвання для дадзенага даччынага элемента';
  ...
  String get demoContainerTransformDemoInstructions =>
      'Карткі, спісы і рухомая кнопка дзеяння';
  ...
  String get demoSharedYAxisDemoInstructions =>
      'Парадак сартавання: \"Нядаўна прайгравалася\"';
  ...
  String get demoFadeScaleDemoInstructions =>
      'Мадальная кнопка і рухомая кнопка дзеяння';
  ...
  String get demoDateRangePickerDescription =>
      'Дыялогавае акно ў Матэрыяльным дызайне, у якім можна выбраць дыяпазон дат.';
  ...
  @override
  String get demo => 'Дэмаверсія';

  @override
  String get bottomAppBar => 'Ніжняя панэль праграм';
  ...
  String get demoTwoPaneFoldableDescription =>
      'Вось так TwoPane выглядае на прыладзе, якая складваецца.';
  ...
  String get demoTwoPaneSmallScreenDescription =>
      'Вось так TwoPane выглядае на прыладзе з малым экранам.';
  ...
  String get demoTwoPaneTabletDescription =>
      'Вось так TwoPane выглядае на прыладах в вялікім экранам, напрыклад на планшэтах і ПК.';
  ...
  String get demoTwoPaneSubtitle =>
      'Адаптыўныя макеты для прылад, якія складваюцца, маюць вялікі ці малы экран';
