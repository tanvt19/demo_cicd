...
class GalleryLocalizationsEl extends GalleryLocalizations {
  ...
  @override
  String get notSelected => 'Δεν έχει επιλεχθεί';

  @override
  String get select => 'Επιλογή';

  @override
  String get selectable => 'Με δυνατότητα επιλογής (παρατεταμένο πάτημα)';
  ...
  String get demoAppBarSubtitle =>
      'Εμφανίζει πληροφορίες και ενέργειες που σχετίζονται με την τρέχουσα οθόνη';

  @override
  String get demoAppBarDescription =>
      'Η γραμμή εφαρμογής παρέχει περιεχόμενο και ενέργειες που σχετίζονται με την τρέχουσα οθόνη. Χρησιμοποιείται στο πλαίσιο της καθιέρωσης επωνυμίας, των τίτλων οθόνης, της πλοήγησης και των ενεργειών';
  ...
  String get demoDividerSubtitle =>
      'Ένα διαχωριστικό είναι μια λεπτή γραμμή που ομαδοποιεί το περιεχόμενο σε λίστες και διατάξεις.';

  @override
  String get demoDividerDescription =>
      'Τα διαχωριστικά μπορούν να χρησιμοποιηθούν για τον διαχωρισμό του περιεχομένου σε λίστες, συρτάρια και σε άλλα σημεία.';
  ...
  String get demoCupertinoContextMenuSubtitle =>
      'Μενού περιβάλλοντος με στιλ iOS';

  @override
  String get demoCupertinoContextMenuDescription =>
      'Ένα μενού περιβάλλοντος πλήρους οθόνης με στιλ iOS, το οποίο εμφανίζεται με το παρατεταμένο πάτημα ενός στοιχείου.';
  ...
  String get demoCupertinoContextMenuActionText =>
      'Πατήστε παρατεταμένα το λογότυπο Flutter για να δείτε το μενού περιβάλλοντος.';
  ...
  @override
  String get demoCupertinoPickerSubtitle => 'Εργαλεία επιλογής τύπου iOS';

  @override
  String get demoCupertinoPickerDescription =>
      'Ένα γραφικό στοιχείο εργαλείου επιλογής τύπου iOS το οποίο μπορεί να χρησιμοποιηθεί για την επιλογή συμβολοσειρών, ημερομηνιών, ωρών ή της ημερομηνίας και της ώρας μαζί.';

  @override
  String get demoCupertinoPickerTimer => 'Χρονόμετρο';

  @override
  String get demoCupertinoPicker => 'Εργαλείο επιλογής';
  ...
  @override
  String get demoCupertinoSearchTextFieldTitle => 'Πεδίο κειμένου αναζήτησης';

  @override
  String get demoCupertinoSearchTextFieldSubtitle =>
      'Πεδίο κειμένου αναζήτησης τύπου iOS';

  @override
  String get demoCupertinoSearchTextFieldDescription =>
      'Ένα πεδίο κειμένου αναζήτησης που επιτρέπει στον χρήστη να κάνει αναζητήσεις καταχωρίζοντας κείμενο και το οποίο μπορεί να προσφέρει και να φιλτράρει προτάσεις.';

  @override
  String get demoCupertinoSearchTextFieldPlaceholder => 'Καταχωρίστε κείμενο';

  @override
  String get demoCupertinoScrollbarTitle => 'Γραμμή κύλισης';

  @override
  String get demoCupertinoScrollbarSubtitle => 'Γραμμή κύλισης τύπου iOS';

  @override
  String get demoCupertinoScrollbarDescription =>
      'Μια γραμμή κύλισης που αναδιπλώνει το θυγατρικό στοιχείο';
  ...
  String get demoDateRangePickerDescription =>
      'Εμφανίζει ένα παράθυρο διαλόγου που περιέχει ένα εργαλείο επιλογής ημερομηνιών Material design.';
  ...
  String get demoSelectionControlsSwitchDescription =>
      'Οι διακόπτες ενεργοποίησης/απενεργοποίησης εναλλάσσουν την κατάσταση μιας μεμονωμένης ρύθμισης. Η επιλογή που ελέγχει ο διακόπτης, καθώς και η κατάσταση στην οποία βρίσκεται, θα πρέπει να αποσαφηνίζεται από την αντίστοιχη ενσωματωμένη ετικέτα.';
  ...
  @override
  String get bottomAppBar => 'Γραμμή εφαρμογής στο κάτω μέρος';
  ...
  String get demoTwoPaneFoldableDescription =>
      'Αυτός είναι ο τρόπος με τον οποίο συμπεριφέρεται το TwoPane σε μια αναδιπλούμενη συσκευή.';
  ...
  String get demoTwoPaneSmallScreenDescription =>
      'Αυτός είναι ο τρόπος με τον οποίο συμπεριφέρεται το TwoPane σε μια συσκευή με μικρή οθόνη.';
  ...
  String get demoTwoPaneTabletDescription =>
      'Αυτός είναι ο τρόπος με τον οποίο συμπεριφέρεται το TwoPane σε μια συσκευή με μεγαλύτερη οθόνη όπως tablet ή υπολογιστή.';
  ...
  String get demoTwoPaneSubtitle =>
      'Αποκριτικές διατάξεις σε αναδιπλούμενες συσκευές, συσκευές με μεγάλη και μικρή οθόνη';
