...
class GalleryLocalizationsZhHk extends GalleryLocalizationsZh {
  ...
  @override
  String get demoAppBarDescription =>
      '應用程式列會提供與目前畫面相關的內容和動作，用於品牌經營、顯示畫面標題、提供導覽及動作';
  ...
  @override
  String get demoCupertinoContextMenuDescription =>
      '常按某個元素時，畫面上就會出現 iOS 樣式的全螢幕內容選單。';
  ...
  @override
  String get demoCupertinoPickerSubtitle => 'iOS 樣式點選器';

  @override
  String get demoCupertinoPickerDescription => 'iOS 樣式的點選器小工具可用於選擇字串、日期和/或時間。';

  @override
  String get demoCupertinoPickerTimer => '計時器';

  @override
  String get demoCupertinoPicker => '點選器';
  ...
  @override
  String get demoCupertinoSearchTextFieldTitle => '搜尋文字欄位';

  @override
  String get demoCupertinoSearchTextFieldSubtitle => 'iOS 樣式的搜尋文字欄位';

  @override
  String get demoCupertinoSearchTextFieldDescription =>
      '搜尋文字欄位可讓使用者透過輸入文字來搜尋，並可提供和篩選建議。';

  @override
  String get demoCupertinoSearchTextFieldPlaceholder => '輸入文字';

  @override
  String get demoCupertinoScrollbarTitle => '捲軸';

  @override
  String get demoCupertinoScrollbarSubtitle => 'iOS 樣式捲軸';

  @override
  String get demoCupertinoScrollbarDescription => '捲軸可將特定子節點換行';
  ...
  @override
  String get demoDateRangePickerDescription =>
      '顯示載有 Material Design 日期範圍點選器的對話框。';
  ...
  @override
  String get bottomAppBar => '底部應用程式列';
  ...
  @override
  String get demoTwoPaneTabletDescription =>
      '這是 TwoPane 在平板電腦或桌面電腦等較大螢幕上的行為方式。';
...
class GalleryLocalizationsZhTw extends GalleryLocalizationsZh {
  ...
  @override
  String get demoAppBarDescription =>
      '應用程式列會提供與目前畫面相關的資訊和動作，可用來宣傳品牌、顯示畫面標題、提供導覽及動作';
  ...
  @override
  String get demoCardDescription =>
      '卡片是一種 Material Design 資訊表，用來表示某些相關的資訊，例如相簿、地理位置、餐點、聯絡人詳細資料等等。';
  ...
  @override
  String get demoDataTableDescription =>
      '資料表格是透過網格格式顯示資訊。網格由列和欄構成，並以方便瀏覽的方式整理資訊，讓使用者能夠找出模式和進行深入分析。';
  ...
  @override
  String get demoNavigationDrawerDescription =>
      '一種 Material Design 面板，只要從畫面邊緣水平向內滑動，即可顯示應用程式中的導覽連結。';
  ...
  @override
  String get demoCupertinoContextMenuDescription =>
      '長按某個元素時，畫面上就會出現 iOS 樣式的全螢幕內容選單。';
  ...
  @override
  String get demoCupertinoPickerSubtitle => 'iOS 樣式的挑選器';

  @override
  String get demoCupertinoPickerDescription =>
      '一種 iOS 樣式的挑選器小工具，可用來選取字串、日期、時間，或者同時選取日期和時間。';

  @override
  String get demoCupertinoPickerTimer => '計時器';

  @override
  String get demoCupertinoPicker => '挑選器';
  ...
  @override
  String get demoCupertinoSwitchSubtitle => 'iOS 樣式切換鈕';

  @override
  String get demoCupertinoSwitchDescription => '你可以使用切換鈕切換單一設定的開啟/關閉狀態。';
  ...
  @override
  String get demoCupertinoSearchTextFieldDescription =>
      '一種搜尋文字欄位，除了可讓使用者輸入文字進行搜尋，還可以提供及篩選建議。';

  @override
  String get demoCupertinoSearchTextFieldPlaceholder => '請輸入一些文字';

  @override
  String get demoCupertinoScrollbarTitle => '捲軸';

  @override
  String get demoCupertinoScrollbarSubtitle => 'iOS 樣式的捲軸';

  @override
  String get demoCupertinoScrollbarDescription => '納入指定子項的捲軸';
  ...
  @override
  String get demoColorsDescription => '代表 Material Design 調色盤的顏色和色樣常數。';
  ...
  @override
  String get demoTypographyDescription => 'Material Design 中的多種版面樣式定義。';
  ...
  @override
  String get demoCircularProgressIndicatorDescription =>
      'Material Design 的圓形進度指標，會以旋轉方式表示應用程式目前忙碌中。';
  ...
  @override
  String get demoLinearProgressIndicatorDescription =>
      'Material Design 的直線進度指標，又稱為進度列。';
  ...
  @override
  String get demoDatePickerDescription => '顯示內含 Material Design 日期挑選器的對話方塊。';

  @override
  String get demoTimePickerTitle => '時間挑選器';

  @override
  String get demoTimePickerDescription => '顯示內含 Material Design 時間挑選器的對話方塊。';
  ...
  @override
  String get demoDateRangePickerDescription =>
      '顯示內含 Material Design 日期範圍挑選器的對話方塊。';
  ...
  @override
  String get demoSnackbarsDescription =>
      'Snackbar 可通知使用者應用程式已執行的處理程序，或即將執行的處理程序。這個元件只會暫時出現在畫面底部，不會影響使用者體驗。使用者不必採取任何動作，這個元件就會自動消失。';
  ...
  @override
  String get demoSelectionControlsSubtitle => '核取方塊、圓形按鈕和切換鈕';
  ...
  @override
  String get demoSelectionControlsSwitchTitle => '切換鈕';

  @override
  String get demoSelectionControlsSwitchDescription =>
      '「開啟/關閉」切換鈕是用來切換單一設定選項的狀態。切換鈕控制的選項及其目前狀態都應在對應的內嵌標籤上清楚顯示。';
  ...
  @override
  String get demoTwoPaneTabletDescription =>
      '這是 TwoPane 在平板電腦或電腦這類大螢幕裝置上的運作方式。';
